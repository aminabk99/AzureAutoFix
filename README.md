...
- **Auto-fixed** : given an admin's Graph access token and the target's object ID, the backend calls Microsoft Graph to resolve it directly (unlock account, add redirect URI, rotate expired secret, etc.) — triggered from the Chrome extension or the `/fix` endpoint
...
needed only for the auto-fix write path (extension / `/fix`) — analysis works without one.
...
`/app`, replacing an earlier Streamlit app (Streamlit reruns its whole script on
every interaction and has no routing). It is read-only and needs no
authentication: paste an error, get the classification, the fix path, and — for
the auto-fixable codes — the manual portal steps.

The web page deliberately does **not** perform the Graph API write itself. That
would mean holding a privileged token in the browser and mutating a live tenant
from a demo, so the page explains the automatic fix instead of running it. The
actual write path lives in the Chrome extension and the `/fix` endpoint, which
take an admin's own Graph access token (see below).
...
Chrome Extension (MV3) · FastAPI · Microsoft Graph API · BM25 + char-ngram hybrid retrieval · Drain · DeepLog (PyTorch) · pytest · GitHub Actions
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      